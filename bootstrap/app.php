...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        /*
         * الثقة بالبوّابة أمام التطبيق.
         *
         * خلف بوّابةٍ تُنهي TLS يصل كل طلب من عنوان الحاوية لا من عنوان صاحبه.
         * وبلا هذه الثقة يقع أمران صامتان: يُسجَّل **كل** زائر بعنوان البوّابة —
         * فيصير خنق الطلبات بالعنوان بلا معنى (زائرٌ واحد نشط يخنق الجميع)،
         * ويسمّي سجلُّ التدقيق البوّابةَ فاعلًا في كل قيد. ويظنّ لارافل الاتصال
         * غير آمن فيبني روابط `http` داخل صفحةٍ على `https`، فيحجبها المتصفح.
         *
         * والنطاقات الخاصة وحدها لا `*`: البوّابة على شبكة Docker، ولا يصل
         * التطبيق أحدٌ سواها (لا منفذ منشور). فلو انكشف منفذه يومًا، لا تُقبل
         * ترويسةٌ منتحَلة من عنوانٍ عامّ.
         */
