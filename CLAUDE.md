...
| `docs/07-دليل-الربط-مع-المشاريع.md` | كل طرق الربط الواردة والصادرة، وكيف تُنشأ حسابات الخدمة |
| `docs/08-المتبقي-من-التنفيذ.md` | **ابدأ من هنا** — ما بُني وما بقي وبأي ترتيب، ودَين تقني مسجَّل |
| `docs/09-تكليف-موازين-باستدعاء-جسر-الوارد.md` | تكليف فنّي **لمن يعمل في مستودع موازين** — كيف يستدعي جسر الوارد |
