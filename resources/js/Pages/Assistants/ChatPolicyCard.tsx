...
/**
 * حوكمة الشات — **إذنٌ لا محتوى، ونشرٌ لا فرض**.
 *
 * هاي روت لا يخزّن رسالةً واحدة من رسائل مستخدمي المشروع؛ هويّاتهم ومحادثاتهم
 * تبقى عنده (وثيقة 01 §6). وما يُضبط هنا يُنشر في جسر الوارد ليقرأه المشروع —
 * **ولا يملك هاي روت منفذًا يُطبّقه به**: القنوات تُبنى في المشروع وتعمل فيه،
 * فالتطبيق قرارُه هو.
 *
 * وكانت هذه البطاقة تقول «إطفاء المالك يسري فورًا». وهي دعوى إنفاذٍ لا يملكها،
 * ومالكٌ يطفئ هنا ويظنّ القناة أُغلقت هناك أسوأُ حالًا ممّن يعلم أنه طلب. ولمّا
 * أعلن موازين أوضاع تفويضه (`local` · `dual` · `hiroote`) صار الفرق ظاهرًا
 * وتصريحًا بالسياسة (hishare24-sketch/hiroote#8).
 */
export function ChatPolicyCard({
    ...
    return (
        <Card>
            <CardHeader
                title="حوكمة الشات"
                description="الإذن يُنشر من هنا، والواجهة يبنيها المشروع وهو من يطبّقه"
            />
            <CardBody>
                <form
                ...
                >
                    <Alert tone="neutral" title="إذنٌ لا محتوى">
                        هاي روت لا يخزّن رسائل مستخدمي المشروع — تبقى عنده. ما يُضبط هنا يُنشر في{' '}
                        <span dir="ltr">GET /api/v1/context</span> ليقرأه المشروع.
                    </Alert>

                    <Alert tone="warning" title="يُنشر ولا يُفرض">
                        القنوات تعمل داخل المشروع، ولا يملك هاي روت منفذًا يُغلقها به: هذا الحفظ
                        يُعلن الإذن، وتطبيقُه قرار المشروع وقد يكون عنده وضع تفويض يجعله استئناسًا
                        لا إلزامًا. فإن كان الإطفاء لازمًا الآن فأطفئه في المشروع نفسه — ولا تُغادر
                        هذه الشاشة محسوبًا أن القناة أُغلقت.
                    </Alert>
